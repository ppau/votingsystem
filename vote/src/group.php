<?php
	...
	class elipticCurve implements group
	{
		...
		{
			return array( 'name' => 'custom', 'curveDescriptor' => array( 'p' => gmp_strval( $this->p, 16 ), 'a' => $this->a->asString( 16 ), 'b' => $this->b->asString( 16 ), 'Gx' => $this->G->x->asString( 16 ), 'Gy' => $this->G->y->asString( 16 ), 'n' => gmp_strval( $this->n, 16 ), 'h' => gmp_strval( $this->h, 16 ) ) );
		}
	...
	class elipticCurveValue implements groupValue
	{
		...
		{
			$temp = $this->scale();
			return array( 'CurveID' => $temp->elipticCurve->asJSONArray(), 'x' => gmp_strval( $temp->x->asBigInt(), 16 ), 'y' => gmp_strval( $temp->y->asBigInt(), 16 ) );
		}
