var tests = {
	...
	'equals_test': function (someTestArgs) {
		var	bigInt_1;
		var	bigInt_2;
		var	result;
		var	expectedResult;
		...
		is (bigInt_1.equals(bigInt_1), true, "equals [1]");
	
		bigInt_1 = new Clipperz.Crypto.BigInt("110");
		bigInt_2 = new Clipperz.Crypto.BigInt("110", 10);
		is (bigInt_1.equals(bigInt_2), true, "equals [2]");

		bigInt_1 = new Clipperz.Crypto.BigInt("110");
		bigInt_2 = new Clipperz.Crypto.BigInt(110);
		is (bigInt_1.equals(bigInt_2), true, "equals [3]");

		bigInt_1 = new Clipperz.Crypto.BigInt(6);
		bigInt_2 = new Clipperz.Crypto.BigInt("110", 2);
		is (bigInt_1.equals(bigInt_2), true, "equals [4]");

		bigInt_1 = new Clipperz.Crypto.BigInt(6);
		bigInt_2 = new Clipperz.Crypto.BigInt("110", 3);
		is (bigInt_1.equals(bigInt_2), false, "equals [5]");

		bigInt_1 = new Clipperz.Crypto.BigInt(0);
		is (bigInt_1.equals(0), true, "equals [6]");
