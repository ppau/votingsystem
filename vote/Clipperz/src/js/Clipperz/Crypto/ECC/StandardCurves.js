...
MochiKit.Base.update(Clipperz.Crypto.ECC.StandardCurves, {
	...
	'_P256': null,
	'P256': function() {	//	NIST P256 curve
		if (Clipperz.Crypto.ECC.StandardCurves._P256 == null) {
			Clipperz.Crypto.ECC.StandardCurves._P256 = new Clipperz.Crypto.ECC.PrimeField.Curve({
				p: new Clipperz.Crypto.BigInt("ffffffff00000001000000000000000000000000ffffffffffffffffffffffff" , 16),
				...
				G: new Clipperz.Crypto.ECC.PrimeField.Point({
					x: new Clipperz.Crypto.BigInt("6b17d1f2e12c4247f8bce6e563a440f277037d812deb33a0f4a13945d898c296" , 16), 
					y: new Clipperz.Crypto.BigInt("4fe342e2fe1a7f9b8ee7eb4a7c0f9e162bce33576b315ececbb6406837bf51f5" , 16), 
					z: new Clipperz.Crypto.BigInt("1")
				}),
		...
		return Clipperz.Crypto.ECC.StandardCurves._P256;
	},
	//==============================================================================
