...
require_once('/Users/admin/Sites/src/group.php');
require_once('/Users/admin/Sites/src/standardCurves.php');
class TestOfEllipticCurve extends UnitTestCase {
	function testElipticCurveAdd(){
		$group = new StandardCurve('P256');
		$p1 = new elipticCurveValue(
			$group,                                                              //eliptic curve
			'7CF27B188D034F7E8A52380304B51AC3C08969E277F21B35A60B48FC47669978' , //x
			'07775510DB8ED040293D9AC69F7430DBBA7DADE63CE982299E04B79D227873D1' , //y
			16);
		$p2 = new elipticCurveValue(
				$group,                                                              //eliptic curve
				'5ECBE4D1A6330A44C8F7EF951D4BF165E6C6B721EFADA985FB41661BC6E7FD6C' , //x
				'8734640C4998FF7E374B06CE1A64A2ECD82AB036384FB83D9A79B127A27D5032' , //y
				16);
		$expected = new elipticCurveValue(
			$group,                                                              //eliptic curve
			'51590B7A515140D2D784C85608668FDFEF8C82FD1F5BE52421554A0DC3D033ED' , //x
			'E0C17DA8904A727D8AE1BF36BF8A79260D012F00D4D80888D1D0BB44FDA16DA4' , //y
			16);                                                                 // base
		$temp = $p1->add($p2);
		$this->assertTrue($temp->equals($expected));
	}
	function testElipticCurveNegate(){
		$group = new StandardCurve('P256');
		$p1 = new elipticCurveValue(
			$group,                                                              //eliptic curve
			'5ECBE4D1A6330A44C8F7EF951D4BF165E6C6B721EFADA985FB41661BC6E7FD6C' , //x
		...
		$expected = new elipticCurveValue(
			$group,                                                              //eliptic curve
			'5ECBE4D1A6330A44C8F7EF951D4BF165E6C6B721EFADA985FB41661BC6E7FD6C' , //x
			'78cb9bf2b6670082c8b4f931e59b5d1327d54fcac7b047c265864ed85d82afcd' , //y
			16);                                                                 // base
		$temp = $p1->negate();
		$this->assertTrue($temp->equals($expected));
	}
	function testElipticCurveSubtract(){
		$group = new StandardCurve('P256');
		$p1 = new elipticCurveValue(
			$group,                                                              //eliptic curve
			'7CF27B188D034F7E8A52380304B51AC3C08969E277F21B35A60B48FC47669978' , //x
	...
	function testElipticCurveDouble(){
		$group = new StandardCurve('P256');
		$expected = new elipticCurveValue(
			$group,                                                              //eliptic curve
			'7CF27B188D034F7E8A52380304B51AC3C08969E277F21B35A60B48FC47669978' , //x
	...
	function testElipticCurveMultiply(){
		$group = new StandardCurve('P256');
		$expected = new elipticCurveValue(
			$group,                                                              //eliptic curve
			'CEF66D6B2A3A993E591214D1EA223FB545CA6C471C48306E4C36069404C5723F' , //x
			'878662A229AAAE906E123CDD9D3B4C10590DED29FE751EEECA34BBAA44AF0773' , //y
			16);                                                                 // base
		$temp = $group->G->intMultiply('10', 10);
		$this->assertTrue($temp->equals($expected));
	}
	function testElipticCurveP256(){
		$group = new StandardCurve('P256');
	...
	function testRandomPoint(){
		$group = new StandardCurve('P256');
		$group->randomMemberNOZero()->asString();
		$temp1 = $group->n_field->randomMemberNOZero();
		$group->G->intMultiply($temp1->asString())->asJson(16);
	}
}